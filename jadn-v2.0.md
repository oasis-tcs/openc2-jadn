...
Variables not configured in a package have an implementation-defined default value, with the recommended
...
in type names generated by schema processing and translation software.
* The $FieldName format MUST NOT permit FieldNames containing the $Sys character, to enable its
use as separator for pathname components.
