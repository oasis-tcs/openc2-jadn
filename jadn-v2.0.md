...
Config = Map{1..*}                                           // Config vars override JADN defaults
   1 $MaxBinary               Integer{1..*} optional         // Schema max octets, default = 255
   2 $MaxString               Integer{1..*} optional         // Schema max characters, default = 255
   3 $MaxElements             Integer{1..*} optional         // Schema max items/properties, default = 255
...
* The $TypeName format MUST permit TypeNames containing the $Sys character.
* The $FieldName format MUST NOT permit FieldNames containing the [JSON Pointer](#rfc6901) field separator
character "/", which is reserved for use in the [Pointers](#55-pointers) shortcut.

*Note: Schema authors SHOULD NOT define TypeNames containing the $Sys character, which is intended for types
generated by schema processing and translation software.*
